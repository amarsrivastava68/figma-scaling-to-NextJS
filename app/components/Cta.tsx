...
export function Cta() {
  return (
    <div className="w-full rounded-[16px] bg-gradient-to-br from-indigo-500 via-green-500 to-red-500 py-[56px] px-[32px] text-center lg:my-[60px] lg:px-[324px] lg:py-[89px]">
